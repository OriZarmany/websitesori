...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="about-container">
        ...
        <p>בן 16 מכפר סבא, ומאז שאני זוכר את עצמי אני אוהד שרוף של מכבי. זו בדיוק הסיבה שהחלטתי להקים את האתר הזה.</p>
        ...
        <ul>
            ...
            <li><strong>גלריה נוסטלגית:</strong> הצצה לכל זכיות מכבי לדורותיהם, הגביעים והרגעים הגדולים.</li>
